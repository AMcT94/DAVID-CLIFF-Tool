...
This dashboard gives you information about which in-demand careers are likely to help you overcome a loss of public assistance and leave you in a better position financially. The dashboard also shows how long it will take to achieve financial stability on a career path.
...
### PROJECTED TAKE-HOME PAY ALONG YOUR CAREER PATH

The chart below compares your employment income before taxes for the career path you chose compared to a near-minimum wage job. If the occupation requires training, your income will be low in the beginning of your career path because you are working part-time to make time for school.  
...
You may be wondering when your family will be able to pay for basic expenses on the chosen career path ('financial stability'). The dashed gray line in the chart below shows the cost of basic expenses ('The ALICE Threshold'). When after-tax family income reaches the amount indicated by the dashed grey line, your family achieves financial stability.
...
### What's Included in the ALICE Threshold?

The ALICE threshold includes seven basic expenses included in the ALICE Household Survival Budget: childcare, food, health insurance, housing, transportation, utilities, and other expenses. Other expenses includes technology and miscellaneous expenses. These expenses change with time and depend on factors like the number and ages of children and geographic differences in cost of living.
...
Would you be better off in the new career instead of staying at the near-minimum wage job? The chart below shows your short-term (1-3 years), medium-term (1-5 and 1-10 years) and long-term (lifetime) gains or losses when switching from the near-minimum wage job to the chosen career. The gains and losses shown in the chart reflect the difference in net financial resources between the two careers.
